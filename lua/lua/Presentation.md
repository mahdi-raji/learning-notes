...
- زبانی high level و multi paradigm (الگو های برنامه نویسی متفاوت : Scripting, Procedural,Functional , Reflective , OOP) است که در سال ۱۹۹۳ توسط سه پژوهشگر برزیلی به نام‌های Roberto Ierusalimschy ، Luiz Henrique de Figueiredo و Waldemar Celes طراحی شد.
...
-  در سیستم‌عامل‌های مختلف اجرا می‌شود. یکی از ویژگی‌های بارز Lua استفاده از یک ساختار داده اساسی است: «جدول».
